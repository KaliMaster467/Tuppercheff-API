...
struct Input;	/* Login.h:7 */
struct ns__iniciar;	/* Login.h:12 */
...
#define SOAP_TYPE_Input (8)
/* complex XSD type 'Input': */
struct SOAP_CMAC Input {
      public:
        /** Optional element 'correo' of XSD type 'xsd:string' */
        char *correo;
        /** Optional element 'contrasena' of XSD type 'xsd:string' */
        char *contrasena;
      public:
...
/* Login.h:12 */
#ifndef SOAP_TYPE_ns__iniciar
#define SOAP_TYPE_ns__iniciar (12)
/* complex XSD type 'ns:iniciar': */
struct SOAP_CMAC ns__iniciar {
      public:
        /** Optional element 'search' of XSD type 'Input' */
        struct Input *search;
      public:
        /** Return unique type id SOAP_TYPE_ns__iniciar */
        int soap_type() const { return SOAP_TYPE_ns__iniciar; }
        /** Constructor with member initializations */
        ns__iniciar()
        {
          search = (struct Input *)0;
        }
        /** Friend allocator used by soap_new_ns__iniciar(struct soap*, int) */
        friend SOAP_FMAC1 ns__iniciar * SOAP_FMAC2 soap_instantiate_ns__iniciar(struct soap*, int, const char*, const char*, size_t*);
};
#endif
...
/* struct ns__iniciar has binding name 'ns__iniciar' for type 'ns:iniciar' */
#ifndef SOAP_TYPE_ns__iniciar
#define SOAP_TYPE_ns__iniciar (12)
#endif
...
#define SOAP_TYPE_PointerTons__Usuario (10)
#endif
...
\******************************************************************************/
    ...
    /** Web service operation 'ns__iniciar' (returns SOAP_OK or error code) */
    SOAP_FMAC5 int SOAP_FMAC6 ns__iniciar(struct soap*, struct Input *search, ns__Usuario *result_soap);
...
SOAP_FMAC5 int SOAP_FMAC6 soap_serve_ns__iniciar(struct soap*);
