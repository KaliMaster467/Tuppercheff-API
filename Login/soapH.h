	...
	const char *Pass)
{
	...
	{	_p->soap_default(soap);
		...
		_p->ns__Usuario::Apellido = Apellido;
		_p->ns__Usuario::Correo = Correo;
		_p->ns__Usuario::Pass = Pass;
	}
	return _p;
}
...
inline int soap_PUT_ns__Usuario(struct soap *soap, const char *URL, ns__Usuario const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns:Usuario", p->soap_type() == SOAP_TYPE_ns__Usuario ? "" : NULL) || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send_ns__Usuario(struct soap *soap, const char *URL, ns__Usuario const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (p->soap_serialize(soap), 0) || p->soap_put(soap, "ns:Usuario", p->soap_type() == SOAP_TYPE_ns__Usuario ? "" : NULL) || soap_end_send(soap))
		return soap->error;
...
inline int soap_GET_ns__Usuario(struct soap *soap, const char *URL, ns__Usuario *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns__Usuario(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv_ns__Usuario(struct soap *soap, ns__Usuario *p)
{
	if (soap_read_ns__Usuario(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
#ifndef SOAP_TYPE_ns__iniciar_DEFINED
#define SOAP_TYPE_ns__iniciar_DEFINED
SOAP_FMAC3 void SOAP_FMAC4 soap_default_ns__iniciar(struct soap*, struct ns__iniciar *);
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_ns__iniciar(struct soap*, const struct ns__iniciar *);
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__iniciar(struct soap*, const char*, int, const struct ns__iniciar *, const char*);
SOAP_FMAC3 struct ns__iniciar * SOAP_FMAC4 soap_in_ns__iniciar(struct soap*, const char*, struct ns__iniciar *, const char*);
SOAP_FMAC1 struct ns__iniciar * SOAP_FMAC2 soap_instantiate_ns__iniciar(struct soap*, int, const char*, const char*, size_t*);

inline struct ns__iniciar * soap_new_ns__iniciar(struct soap *soap, int n = -1)
{
	return soap_instantiate_ns__iniciar(soap, n, NULL, NULL, NULL);
}

inline struct ns__iniciar * soap_new_req_ns__iniciar(
	struct soap *soap)
{
	struct ns__iniciar *_p = soap_new_ns__iniciar(soap);
	if (_p)
	{	soap_default_ns__iniciar(soap, _p);
	}
	return _p;
}

inline struct ns__iniciar * soap_new_set_ns__iniciar(
	struct soap *soap,
	struct Input *search)
{
	struct ns__iniciar *_p = soap_new_ns__iniciar(soap);
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_ns__iniciar(struct soap*, const struct ns__iniciar *, const char*, const char*);

inline int soap_write_ns__iniciar(struct soap *soap, struct ns__iniciar const*p)
{
	soap_free_temp(soap);
	if (soap_begin_send(soap) || (soap_serialize_ns__iniciar(soap, p), 0) || soap_put_ns__iniciar(soap, p, "ns:iniciar", "") || soap_end_send(soap))
			return soap->error;
	return SOAP_OK;
}

inline int soap_PUT_ns__iniciar(struct soap *soap, const char *URL, struct ns__iniciar const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_ns__iniciar(soap, p), 0) || soap_put_ns__iniciar(soap, p, "ns:iniciar", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send_ns__iniciar(struct soap *soap, const char *URL, struct ns__iniciar const*p)
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_ns__iniciar(soap, p), 0) || soap_put_ns__iniciar(soap, p, "ns:iniciar", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
SOAP_FMAC3 struct ns__iniciar * SOAP_FMAC4 soap_get_ns__iniciar(struct soap*, struct ns__iniciar *, const char*, const char*);

inline int soap_read_ns__iniciar(struct soap *soap, struct ns__iniciar *p)
{
	if (p)
	{	soap_default_ns__iniciar(soap, p);
		if (soap_begin_recv(soap) || soap_get_ns__iniciar(soap, p, NULL, NULL) == NULL || soap_end_recv(soap))
			return soap->error;
	}
	return SOAP_OK;
}

inline int soap_GET_ns__iniciar(struct soap *soap, const char *URL, struct ns__iniciar *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read_ns__iniciar(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv_ns__iniciar(struct soap *soap, struct ns__iniciar *p)
{
	if (soap_read_ns__iniciar(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
...
inline int soap_PUT_Input(struct soap *soap, const char *URL, struct Input const*p)
{
	soap_free_temp(soap);
	if (soap_PUT(soap, URL, NULL, NULL) || (soap_serialize_Input(soap, p), 0) || soap_put_Input(soap, p, "Input", "") || soap_end_send(soap) || soap_recv_empty_response(soap))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_send_Input(struct soap *soap, const char *URL, struct Input const*p)
{
	soap_free_temp(soap);
	if (soap_connect(soap, URL, NULL) || (soap_serialize_Input(soap, p), 0) || soap_put_Input(soap, p, "Input", "") || soap_end_send(soap))
		return soap->error;
	return SOAP_OK;
}
...
inline int soap_GET_Input(struct soap *soap, const char *URL, struct Input *p)
{
	if (soap_GET(soap, URL, NULL) || soap_read_Input(soap, p))
		return soap->error;
	return SOAP_OK;
}

inline int soap_POST_recv_Input(struct soap *soap, struct Input *p)
{
	if (soap_read_Input(soap, p) || soap_closesock(soap))
		return soap->error;
	return SOAP_OK;
}
#endif
